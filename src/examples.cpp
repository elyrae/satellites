...
// double ftime(Surface::Timegrid &tg, const SwarmMethod::Point& vect)
// {
...
//     p += penalty(Stuff::degrees_to_rad(50.0), orbitsVector[7], Stuff::degrees_to_rad(80.0));
//     p += penalty(Stuff::degrees_to_rad(50.0), orbitsVector[8], Stuff::degrees_to_rad(80.0));
//     p += penalty(Stuff::degrees_to_rad(50.0), orbitsVector[9], Stuff::degrees_to_rad(80.0));
//     p += penalty(Stuff::degrees_to_rad(50.0), orbitsVector[10],Stuff::degrees_to_rad(80.0));
...
//     region.push_back({Stuff::degrees_to_rad(50.0), Stuff::degrees_to_rad(80.0)});
//     region.push_back({Stuff::degrees_to_rad(50.0), Stuff::degrees_to_rad(80.0)});
//     region.push_back({Stuff::degrees_to_rad(50.0), Stuff::degrees_to_rad(80.0)});
//     region.push_back({Stuff::degrees_to_rad(50.0), Stuff::degrees_to_rad(80.0)});

//     SwarmMethod::Parameters params;
//     params.swarm_size = 500;
//     params.omega = -0.32;
//     params.phi = 2.0;
...
//         auto sol = SwarmMethod::optimize(ftime, region, params, show_iterations);
//         std::cout << "\n";
//         std::cout.flush();
//     }
...
// void Examples::swarm_optimisation2()
// {
//     Orbits::Constellation orbits = Orbits::read_circular_orbits("circularOrbits.txt");
//     std::cout << "Loaded orbits:\n";
//     Orbits::print_circular_orbits(orbits);
...
//     const size_t constellation_size = 20;
//     Surface::Timegrid tg(constellation_size, "../data/grids/centroids_5000.txt", "../data/grids/areas_5000.txt");
